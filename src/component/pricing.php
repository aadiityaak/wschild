...
<div class="umroh-pricing-main">
	<div class="umroh-pricing-header">
		<h2 class="umroh-pricing-main__title">Pricing</h2>
		<p class="umroh-pricing-main__subtitle">Pilih Paket yang Sesuai dengan Kebutuhan Bisnis Anda</p>
	</div>

	<div x-data='wschildPricing(<?php echo wp_json_encode($design_data); ?>)'>
		<div class="umroh-grid umroh-grid--3 umroh-pricing">
