...
add_action('wp_enqueue_scripts', function () {
	...
	if (is_page_template('page-templates/landing-jasa-website-umroh.php') || is_page_template('page-templates/home.php') || is_page_template('page-templates/about-us.php') || is_page_template('page-templates/services.php') || is_page_template('page-templates/pricing.php')) {
		wp_enqueue_style(
			'swiper-css',
