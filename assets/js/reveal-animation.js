(function () {
  window.wschildInitRevealAnimations = function (root) {
    ...
    const reveal = (elements, options = {}) => {
      const els = typeof elements === "string" ? scope.querySelectorAll(elements) : elements;
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    window.wschildInitRevealAnimations(document);
  });
})();
